...
<a class="button radius radius small" href="http://www.vnbooking.com/article/view/63" target="_blank"><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('system/update','Update instructions')?></a>
<?php else : ?>
